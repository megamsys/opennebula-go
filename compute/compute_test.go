...
func (s *S) TestCreate(c *check.C) {
	...
	vmObj := VirtualMachine{Name: "yeshapp_new_files", TemplateName: "fullon", Cpu: "1", Memory: "1024", Assembly_id: "ASM007", Client: client, ContextMap: map[string]string{"ASSEMBLYID": "ASM007", "ASSEMBLIESID": "AMS007"}} //memory in terms of MB! duh!
